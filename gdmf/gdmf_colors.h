...
#ifndef GDMF_COLORS_H
#define GDMF_COLORS_H

#include <stdbool.h>
#include <stdint.h>

#define GDMF_COLORS_VERSION "0.3.2026071501 COLON"
...
// Monotonic counter bumped on every Colors[] mutation (SetColorsPalette,
// SetColorsPaletteColor, InitColorsPalettes). Consumers that mirror the
// table to the GPU compare against the last generation they uploaded and
// skip the work when it hasn't moved. Never returns 0.
uint32_t GetColorsGeneration(void);
